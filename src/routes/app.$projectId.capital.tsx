  ...
  return (
    <div className="px-6 lg:px-12 py-10 max-w-5xl mx-auto space-y-8 pb-20">
      ...
      <section className="bg-card rounded-3xl border border-border p-8 md:p-10 shadow-warm-sm relative overflow-hidden">
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="font-serif text-4xl md:text-5xl font-medium">Capital</h1>
          ...
          <p className="mt-4 text-muted-foreground leading-relaxed max-w-2xl">
            Track funding rounds, investor relationships, and capital planning for your project.
          </p>
        </div>
      </section>
      ...
      <section className="bg-card rounded-2xl border border-border p-12 text-center">
        <Rocket className="size-12 mx-auto text-muted-foreground/50 mb-4" />
        <h3 className="font-serif text-xl font-medium mb-2">Capital tracking coming soon</h3>
        <p className="text-sm text-muted-foreground">
          This feature is under development. Use the Money page to track your break-even and
          pricing for now.
        </p>
      </section>
    </div>
