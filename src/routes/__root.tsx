  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="font-mono text-xs uppercase tracking-widest text-terracotta">404</p>
...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "GapFriend is an AI-powered co-pilot for project execution and funding.",
      },
      {
        property: "og:description",
        content: "GapFriend is an AI-powered co-pilot for project execution and funding.",
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/41fde877-f36e-4ae6-892b-1414eafd666a/id-preview-5f1cc28f--56eff0b5-e578-4791-9982-f1648c6afdb2.lovable.app-1776450900334.png",
      },
      {
        name: "twitter:image",
        content:
